...
The Smart CDN is available for each of our [pricing plans](/docs/v2/platform/limits.mdx#plans) and can be activated for [Serverless Functions](/docs/v2/serverless-functions/introduction) by providing [`Cache-Control` headers](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Cache-Control).
